...
class ResultScreen extends StatelessWidget {
  ...
  String _priceSegment(
    Map<String, dynamic> item,
    int index,
  ) {
    final value = item['priceSegment']
        ?.toString()
        .trim()
        .toLowerCase();
    ...
    if (value != null) {
      ...
      if (value.contains('ekonomik') ||
          value.contains('budget')) {
        return 'Ekonomik';
      }

      if (value.contains('orta') ||
          value.contains('mid')) {
        return 'Orta Segment';
      }
    }
  ...
  String _storeSubtitle(
    ...
    return switch (store) {
      'trendyol' =>
        'Trendyol’da ürün adı ve renk koduyla ara',
      'gratis' =>
        'Gratis sonuçlarında ürünü ara',
      'watsons' =>
        'Watsons sonuçlarında ürünü ara',
      'sephora' =>
        'Sephora sonuçlarında ürünü ara',
      'boyner' =>
        'Boyner sonuçlarında ürünü ara',
      'amazon' =>
        'Amazon Türkiye’de ürünü ara',
      'official' =>
        'Markanın resmî satış sayfasını aç',
  ...
  Future<void> _openStore({
    ...
    final opened =
        await ProductLinkService.openStore(
      store: store,
      brand: brand,
      product: product,
      shade: shade,
    ...
    ScaffoldMessenger.of(pageContext)
      ...
      ..showSnackBar(
        SnackBar(
          content: Text(
            '${_storeTitle(store)} bağlantısı açılamadı.',
          ),
        ),
      );
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  _storeButton(
                    ...
                    title: 'Google’da Ara',
                    subtitle:
                        'Diğer mağaza ve fiyat seçeneklerini gör',
                    onTap: () {
                      _openStore(
                        sheetContext:
                            sheetContext,
  ...
  String _recommendationText(
    ...
    for (int index = 0;
      ...
      buffer.writeln(
        'Fiyat: ${_priceText(item)}',
      );

      buffer.writeln(
        'Fiyat Kategorisi: ${_priceSegment(item, index)}',
      );
...
''';
  ...
  Future<void> _copyAnalysis(
    ...
    ScaffoldMessenger.of(context)
      ...
      ..showSnackBar(
        const SnackBar(
          content: Text(
            'Analiz panoya kopyalandı.',
          ),
        ),
      );
  }

  Future<void> _selectAllAnalysis(
    BuildContext context,
  ) async {
    final controller =
  ...
  Widget _recommendationItem({
    ...
    final skinTypesValue =
        item['skinTypes'];

    final skinTypes =
        skinTypesValue is List
            ? skinTypesValue
                .map(
                  (value) => value
                      .toString()
  ...
  Widget
      _affordableFoundationSection(
    BuildContext context,
  ) {
    final value = result[
        'affordableFoundationAlternatives'];
